...
class TestUniversalJSONDecoder:
    ...
    def test_universal_decoder_with_registry(self, mocker: MockerFixture) -> None:
    ...
    def test_universal_decoder_import_module_failure(self, mocker: MockerFixture) -> None:
    ...
    def test_universal_decoder_registered_decoder_success(self) -> None:
    ...
    def test_universal_decoder_registered_decoder_failure_no_fallback(self) -> None:
    ...
    def test_universal_decoder_registered_decoder_failure_with_fallback(self, mocker: MockerFixture) -> None:
    ...
    def test_universal_decoder_json_decode_method_success(self) -> None:
    ...
    def test_universal_decoder_json_decode_method_failure_no_fallback(self) -> None:
    ...
    def test_universal_decoder_root_model_creation_failure(self) -> None:
    ...
    def test_universal_decoder_root_model_validation_failure(self, mocker: MockerFixture) -> None:
    ...
    def test_universal_decoder_base_model_success(self) -> None:
    ...
    def test_universal_decoder_base_model_validation_failure_with_constructor_success(self) -> None:
    ...
    def test_universal_decoder_base_model_all_validation_failures(self) -> None:
    ...
    def test_universal_decoder_base_model_constructor_success_validation_failure(self, mocker: MockerFixture) -> None:
    ...
    def test_universal_decoder_constructor_with_dict_success(self) -> None:
    ...
    def test_universal_decoder_default_constructor_success(self) -> None:
    ...
    def test_universal_decoder_all_methods_fail_return_dict(self) -> None:
    ...
    def test_log_method(self, mocker: MockerFixture) -> None:
        ...
        mock_debug = mocker.patch.object(self.decoder.logger, "debug")
        self.decoder.log("test message")
