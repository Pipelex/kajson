...
class TestPydanticSubclassSerialization:
    ...
    def test_basic_subclass_serialization(self):
        ...
        Animal.__module__ = "fake.animal.module"
        Dog.__module__ = "fake.animal.module"
        Cat.__module__ = "fake.animal.module"
        Pet.__module__ = "fake.animal.module"
    ...
    def test_complex_nested_subclass_hierarchy(self):
        """Test complex nested subclass hierarchy with multiple levels of inheritance."""
        ...
        # Set fake module names to force class registry usage
        Vehicle.__module__ = "fake.vehicle.module"
        MotorVehicle.__module__ = "fake.vehicle.module"
        Car.__module__ = "fake.vehicle.module"
        SportsCar.__module__ = "fake.vehicle.module"
        Truck.__module__ = "fake.vehicle.module"
        Fleet.__module__ = "fake.vehicle.module"
        ...
        # Verify specific subclass types and attributes
        assert len(restored_fleet.vehicles) == 3

        # First vehicle should be SportsCar
        ...
        # Second vehicle should be Truck
        ...
        # Third vehicle should be Car (not SportsCar)
        ...
        print("✅ Complex nested subclass hierarchy preserved correctly!")
    ...
    def test_abstract_base_with_concrete_subclasses(self):
        ...
        # Set fake module names to force class registry usage
        Shape.__module__ = "fake.shape.module"
        Rectangle.__module__ = "fake.shape.module"
        Circle.__module__ = "fake.shape.module"
        Drawing.__module__ = "fake.shape.module"
